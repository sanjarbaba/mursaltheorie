...
import { SOURCES,SIGNS,signByCode,WORLDS,CHAPTERS,LEVELS,MODES,SCENARIOS,PRIORITY_QUESTIONS,SPEED_QUESTIONS,WORLD_CONFIG } from './_game-data.js';
...
export async function GET(request) {
  ...
  try {
    ...
    if (!new URL(request.url).searchParams.has('check')) data.content = {SOURCES,SIGNS,signByCode,WORLDS,CHAPTERS,LEVELS,MODES,SCENARIOS,PRIORITY_QUESTIONS,SPEED_QUESTIONS,WORLD_CONFIG};
    return json({data});
  } catch {
