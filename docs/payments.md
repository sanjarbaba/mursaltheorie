...
Schakel minimaal het event `checkout.session.completed` in. De webhook controleert de Stripe-handtekening, slaat alleen minimale transactiegegevens op en activeert daarna `theory_b_access` voor het ingelogde account. Herhaalde events zijn idempotent.
